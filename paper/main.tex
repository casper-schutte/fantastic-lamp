...
In both of these validation tests, \textit{FantasticLamp} was able to identify the correct edit state for 97 out of 100 edits. For these tests, we defined ``correct edit state'' as a fractional edit coverage of at least 0.5. This fractional coverage was calculated by taking edit coverage and dividing it by the total coverage for both the edit and reference paths, producing a value between 0 and 1. 
